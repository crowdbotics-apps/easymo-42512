"""
Django settings for easymo_42512 project.
...
ROOT_URLCONF = 'easymo_42512.urls'
...
WSGI_APPLICATION = 'easymo_42512.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "easymo_42512 API",
    "DESCRIPTION": "API documentation for easymo_42512 App",
    "VERSION": "v1",
}
